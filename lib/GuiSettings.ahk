...
OnOpenSettings(*) {
    ...
    dg.Add("Text", "x15 y338 w" fullW " h20 c888888"
    ...
    dg.Add("Button", "x15 y368 w90 h30 Default", "적용")
       .OnEvent("Click", (*) => _ApplySettings(dg, edPat, edDir, edFrameKW, edAlbumKW, chkCase, chkRx))
    dg.Add("Button", "x115 y368 w90 h30", "기본값")
       .OnEvent("Click", (*) => (
    ...
    dg.Add("Button", "x" (fullW - 75) " y368 w90 h30", "닫기")
       .OnEvent("Click", (*) => dg.Destroy())
    dg.OnEvent("Close", (*) => dg.Destroy())

    dg.Show("w" (fullW + 15) " h410")
}

_ApplySettings(dg, edPat, edDir, edFrameKW, edAlbumKW, chkCase, chkRx) {
